								...
								<div className='flex'>
									...
									<div className='flex flex-col flex-[8] gap-2 mt-5 sm:mr-1'>
										...
										<p className='text-[0.6rem] sm:text-xs mt-2 text-gray-400'>
											...
											consectetur adipisicing elit. Cumque culpa corporis
											placeat veniam dolor vel perferendis provident nesciunt
											fuga sit. Eligendi qui natus cupiditate ducimus numquam
											tenetur adipisci dolore tempore!
										</p>
										<UserCardQuestion
											userId='Mario Pineda'
											...
											<div className='ml-5'>
												<p className='text-xs text-start'>
													<span className='block mb-1'>
														Yo opino que todo eso está muy bien, siempre y
														cuando se respete, bla bla lorem Lorem ipsum dolor
														sit amet consectetur adipisicing elit. Velit
														consequatur eligendi praesentium accusantium quas
														impedit, doloribus expedita excepturi porro optio
														quia adipisci maxime. Perferendis debitis officiis
														corporis possimus neque ratione!
													</span>
													<span className='text-gray-500'>Escrito </span>hoy a
													las 13:00 por{' '}
											...
											<div className='ml-5'>
												<p className='text-xs text-start'>
													<span className='block mb-1'>
														...
														quas impedit, doloribus expedita excepturi porro
														optio quia adipisci maxime. Perferendis debitis
														officiis corporis possimus neque ratione!
													</span>
													<span className='text-gray-500'>Escrito </span>hoy a
													las 13:00 por{' '}

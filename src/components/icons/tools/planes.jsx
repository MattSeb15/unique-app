export function ToolsPaperPlaneTil(props) {
	return (
		<svg
...
export function ToolsPaperPlaneRight(props) {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			width='1em'
			...
			<g fill='currentColor'>
				<path
					d='M219.91 134.86L51.93 231a8 8 0 0 1-11.44-9.67l31-90.71a7.89 7.89 0 0 0 0-5.38l-31-90.47a8 8 0 0 1 11.44-9.67l168 95.85a8 8 0 0 1-.02 13.91Z'
					opacity='.2'
				/>
